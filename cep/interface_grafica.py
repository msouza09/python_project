...
def tela_inicial():
    ...
    coluna2 = [
        ...
        [sg.Input(font='arial bold', key='localidade', size=(30, 1))],
        [sg.Input(font='arial bold', key='uf', size=(4, 1))],
        [sg.Input(font='arial bold', key='ibge', size=(15, 1))],
        [sg.Input(font='arial bold', key='ddd', size=(4, 1))],
      ]

    botoes = [
        [sg.Button('Consultar', font='arial 12', size=(10, 1), pad=((0, 15), 0)),
         sg.CButton('Sair', font='arial 12', size=(8, 11))]
]
